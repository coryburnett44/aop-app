...
def event_out(e: dict) -> dict:
    return {
        ...
        "rsvps_closed": bool(e.get("rsvps_closed")),
...
# ---------- Member admin operations — extracted to routes/members_admin.py ----------
# (admin create/update/delete, CSV bulk import, set-password resends, role/chapter/tier assignment)
...
# ============================================================
from fastapi import WebSocket, WebSocketDisconnect  # noqa: F401,E402
...
# read via a callable so any future re-key swap is picked up at call time.
from routes import members_admin as routes_members_admin  # noqa: E402
routes_members_admin.register(
    api,
    db=db,
    iso=iso,
    now_utc=now_utc,
    ...
    all_admin_tabs=ALL_ADMIN_TABS,
    send_welcome_email=send_welcome_email,
    send_set_password_email=_send_set_password_email,
    resend_api_key_getter=lambda: RESEND_API_KEY,
)
